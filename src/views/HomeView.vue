...
<template>
  <section id="home" class="row h-100">
    <div class="col-2 lateral-nav-right d-flex flex-wrap">
      <ul class="d-flex flex-column justify-content-end m-0">
        <li>
          <a
        ...
        <li>
          <a href="mailto:valentina.webdev@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
              height="40"
    ...
    <section
      class="col-8 wrapper_inner my-5 d-flex justify-content-center flex-wrap"
    >
